...
export function descriptor(id = 'test.provider', overrides = {}) { return {contract: 'ofu-px-contracts-1', id, version: '1.0.0', owner: 'test', kind: 'domain', authority: authority(), fidelity, lifecycle: 'SHIPPING', requires: [], claims: [id], operations: ['INSPECT'], budget, evidence: [{id: 'test.fixture', tier: 'FAST_LOCAL'}, {id: 'test.integration', tier: 'INTEGRATION'}], mandatory: true, ...overrides}; }
