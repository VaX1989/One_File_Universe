...
const baseline={contract:'ofu-integration-p3-baseline-v1',p3ManifestHash:manifestHash,system:A.canonicalEnvelope(found.system),star:A.canonicalEnvelope(star),planet:A.canonicalEnvelope(found.planet)};
