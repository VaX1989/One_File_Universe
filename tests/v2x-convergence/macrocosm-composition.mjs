...
let originalCalls=0,providerCalls=0,regionArgs=null,projectionCalls=0;
...
const provider=Object.freeze({
 ...
 buildNeighborhood(args){providerCalls++;return Object.freeze({scale:'NEIGHBORHOOD',sourceId:'n',objects:Object.freeze([{sourceId:'neighbor'}]),camera:Object.freeze({consumedExternalFrame:true})})}
});
