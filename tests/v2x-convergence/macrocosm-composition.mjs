...
const provider=Object.freeze({
 ...
 buildRegion(args){providerCalls++;return Object.freeze({scale:'REGION',sourceId:args.parentId,objects:Object.freeze([{sourceId:'region'}])})},
...
assert.equal(S.representation({context:'REGION',scopeId:'r',entities:[],cameraFrame:{}}).objects[0].sourceId,'region');
