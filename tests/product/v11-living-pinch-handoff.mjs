...
console.log(JSON.stringify({status:'PASS',suite:'v11-living-pinch-handoff',cases,version:'ofu-v11-living-pinch-handoff-4',authority:'PRESENTATION_ONLY',dragThresholdPx:5,captureOwnedHandoff:true,cancelFailsClosed:true,lostCaptureFailsClosed:true}));
