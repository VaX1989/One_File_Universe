...
try{
 ...
 const evidence={status:'PASS',exactSourceSha:sourceSha,product:'Living choice semantics',shippingForeground:'living-panel',navigationButtonsAreNotToggles:true,localObjectSelectionState:true,localSelectionSemanticsVerified:selected.adapter.selectionChoicesVerified,singleSelectedObjectState:true,authority:'PRESENTATION_ONLY',directFile:true,offline:true};fs.writeFileSync(path.join(evidenceDir,'living-choice-semantics.json'),JSON.stringify(evidence,null,2)+'\n');console.log(JSON.stringify(evidence));
