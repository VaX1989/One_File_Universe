...
assert.deepEqual([...R.CURRENT_BANDS],['galaxy','stellar_neighborhood','system','orbit','approach','global_surface','regional_surface','local_surface','human']);
...
R.registerSceneProvider({id:'wave-iv-macro',scales:['galaxy','stellar_neighborhood','system'],setActive:v=>{systemActive=v}});
