...
async function cycle(firstId,secondId,liftId,moveId){
 ...
 const thresholdImmediate=await fire('pointermove',moveId,startX+2,251,true);
 ...
 const beforeMove=await quiet(),immediate=await fire('pointermove',moveId,startX+36,268,true);
