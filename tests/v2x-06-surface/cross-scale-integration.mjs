...
const address=A.locate('world-cross-scale',12345678,-76543210,3),observables={surfaceLocationIdentity:address.locationIdentity,surfacePlanetIdentity:address.planetIdentity};
