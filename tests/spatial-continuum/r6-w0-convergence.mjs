...
import './r6-w0-macro-suppression-wrapper.mjs';
...
console.log(JSON.stringify({status:'PASS',suite:'spatial-continuum-r6-w0-convergence-contracts',phase2:['CONV-A','CONV-BD','CONV-C','CONV-E','CONV-F','CONV-I'],lanes:['R6-A','R6-B','R6-D','R6-C','R6-E','R6-F','R6-I','R6-G'],phase2Corrections:['FROZEN_OPEN_UNIVERSE_WRAPPER']},null,2));
