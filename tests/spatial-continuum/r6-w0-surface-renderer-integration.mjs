...
console.log(JSON.stringify({status:'PASS',suite:'r6-w0-phase2-surface-renderer-integration',representationHandoff:true,renderedSeamStitching:true,lodTransition:true,cameraForwardCulling:true,hysteresis:true,boundedTransitionResidency:true,sceneAuthorities:1,cameraAuthorities:1},null,2));
