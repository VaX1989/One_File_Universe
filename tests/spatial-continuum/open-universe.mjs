...
try{
  ...
  assert.ok(firstMicro.render.lazyRepresentations.resident.includes('molecular'));assert.ok(firstMicro.render.lazyRepresentations.resident.length<6,'direct inspection must create only required GPU representations');
