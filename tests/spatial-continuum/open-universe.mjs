...
try{
  ...
  const output={status:'PASS',suite:'spatial-continuum-r4-open-universe',visibleGalaxies:initial.openUniverse.visibleGalaxies,distinctGalaxyBranches:branches.length,selectedWorld:selected,selectedSurface,selectedSamples:[firstObject,secondObject],address:secondMicro.openUniverse.currentAddress.serialized,cache:secondMicro.openUniverse.cache,rendererOwnedGalaxyPicking:true,rendererOwnedSurfacePicking:true,rendererOwnedLocalPicking:true,planetaryTopology:global.render.planetaryLod.topology,microVariation:true,runtimeNetworkRequests:network.length,errors};
