...
const event=(u,l,a,sec,op)=>T.canonicalEvent({universeIdentity:u,lineageId:l,time:{seconds:sec,micros:0n},type:'core.field.set',version:1n,operationKey:op,targets:[a],payload:{field:'x',value:op},causes:[],preconditionStateDigest:null});const e1=event(u1,l1,a1,1n,'u1'),e2=event(u2,l2,a2,2n,'u2');
