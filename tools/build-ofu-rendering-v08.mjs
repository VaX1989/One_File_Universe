...
const extensionPaths=['src/bootstrap/product/selection-bridge.js','src/rendering/planet-framing.js','src/bootstrap/product/explore-navigation.js','src/bootstrap/product/inspector-product.js','src/bootstrap/product/mobile-interaction.js','src/bootstrap/product/lab-technical.js','src/bootstrap/product/mobile.css'];
...
const extensionScripts=['src/bootstrap/product/selection-bridge.js','src/rendering/planet-framing.js','src/bootstrap/product/explore-navigation.js','src/bootstrap/product/inspector-product.js','src/bootstrap/product/mobile-interaction.js','src/bootstrap/product/lab-technical.js'].map(path=>`<script>${read(path).trimEnd().replace(/<\/script/gi,'<\\/script')}</script>`).join('');
...
manifest.productSourceComposition='v08-product-template-fragments-3';
