...
result={'status':'PASS','oracle':'independent-python-ofu-cbv-subset-v1','manifestHash':manifest_hash.hex(),'biosphereId':biosphere.hex(),'lineageId':lineage.hex(),'speciesId':species.hex(),'primaryProductivityCeilingU':str(primary),'sustainableBiomassCeilingU':str(biomass),'trophic100kLevel1U':str(trophic(primary,100_000)),'canonicalGenesisAvailable':False,'persistentLineageTransitions':False,'numericLaw':'u64 integer; ppm multiplication uses exact floor; overflow is rejection in runtime'}
...
for k in ['manifestHash','biosphereId','lineageId','speciesId','primaryProductivityCeilingU','sustainableBiomassCeilingU','trophic100kLevel1U','canonicalGenesisAvailable','persistentLineageTransitions']:
