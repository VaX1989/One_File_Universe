...
const specs=[
 ...
 ['src/bootstrap/ofu-inspector.js','Integration','canonical-inspector','D0','p1-p5-candidate']
];
...
const buildPublic={baselineSchemaVersion:1,candidateOnly:true,releaseLine:'v0.5.0-preview-candidate',sourceCommit,artifact:'One_File_Universe.html',phases:['P1','P2','P3','P4','P5'],componentManifestHash,p2:{canonicalBytes:'OFU-CBV-1',corpusDigest:p2.corpusDigest,kernelDigest:p2.kernelDigest,semanticManifestHash:p2.semanticManifestHash,universeIdentity:p2.universeIdentity,unicodeProfile:p2.unicodeProfile},p3:{schemaVersion:p3.schemaVersion,modelVersion:p3.modelVersion,baselineEpoch:p3.baselineEpoch,corpusDigest:p3.expectedDigest,semanticManifestHash:p3.manifestHash},p4:{protocol:'ofu-p4-temporal-v1',transitionContract:'ofu.p4.core-transition@1.0.0',eventSchemaVersion:1,checkpointSchemaVersion:2,archiveSchemaVersion:2},p5:{schemaVersion:1,physicalContract:'ofu-p5-planet-physical-v1',modelVersion:'p5-planet-physical-1',p3InputContract:'ofu-p3-p5-planetary-input-v1',terrainTopology:'p5-cube-sphere-topology-1',p6EnvironmentContract:'ofu-p5-p6-environment-v1',persistentMutableStatePromoted:false},runtime:{strictSingleFile:true,directFile:true,offline:true,networkRequired:false},knownLimitations:['P5 canonical candidate supports bounded 1-8 Earth-mass TERRESTRIAL realization only','VOLATILE_RICH, ICE_GIANT and GAS_GIANT physical families remain unsupported','Atmosphere, climate, hydrosphere and geological evolution remain research/deferred','Terrain elevation code is explicitly FICTIONAL/STYLIZED and dimensionless','Real Safari/iOS not verified; Playwright WebKit is reported as WebKit only']};
