...
export function buildHumanSummary(report){
  ...
  return [
    ...
    '',
    report.crossProgram?`Declared capabilities: ${report.crossProgram.declaredCapabilities.length}; staged evidence rows: ${report.crossProgram.stagedEvidence.length}; declared-without-evidence rows: ${report.crossProgram.missingEvidence.length}. Authority: observation/falsification only; scientific truth and release authority remain false.`:'No cross-program evidence report was produced.',
    '',
    '## Failures',
    '',
