# One File Universe Commercial Licensing

**Status: commercial-licensing policy foundation; this document is not itself a commercial license or offer.**
...
- **Same Open Source Core.** Commercial licensing must not be used to intentionally cripple the community core in order to force payment.
- **Additional rights, not revoked rights.** A commercial agreement may grant extra permissions; it cannot revoke GPL rights already granted for an Open Source release.
- **No automatic revenue tax.** The Open Source license contains no revenue percentage, usage royalty, or commercial-use fee.
...
Future offerings may include proprietary/OEM redistribution rights, enterprise support, certified builds, long-term support, integration services, scientific-validation services, trademark/certification programs, or hosted/distributed products.

These are business possibilities, not promises and not part of GPL-3.0-only.
...
The final legal person or entity authorized to sign commercial licenses has not been encoded into this repository by this policy foundation. That designation must be explicit, legally reviewed, and recorded before commercial agreements are issued on behalf of the project.
