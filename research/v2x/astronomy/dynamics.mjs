...
export function shortHorizonNBodyDiagnostic({ starMassSolar, planets, timestepYears, steps, minimumSeparationAuFloor = 1e-8, barycentricizeInitialState = true }) {
  ...
  return Object.freeze({
    ...
    invariantUnits: Object.freeze({
      energy: 'MSUN_AU2_PER_YR2',
      angularMomentum: 'MSUN_AU2_PER_YR',
      linearMomentum: 'MSUN_AU_PER_YR'
    }),
    initialEnergyMsunAu2PerYr2: initial.energy,
    finalEnergyMsunAu2PerYr2: final.energy,
    relativeEnergyDrift,
    initialAngularMomentumMsunAu2PerYr: initial.angularMomentum,
    finalAngularMomentumMsunAu2PerYr: final.angularMomentum,
    relativeAngularMomentumDrift,
    initialLinearMomentumMsunAuPerYr: Object.freeze({ x: initial.linearMomentumX, y: initial.linearMomentumY }),
    finalLinearMomentumMsunAuPerYr: Object.freeze({ x: final.linearMomentumX, y: final.linearMomentumY }),
