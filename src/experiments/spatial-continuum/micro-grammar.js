...
function molecularPoints(grammar,rnd){
  ...
  if(topology==='LATTICE_ORIENTED_PRESENTATION')for(let z=-1;z<=1;z++)for(let x=-1;x<=1;x++)points.push(frozenPoint([x*1.35,(x+z)%2*.34,z*1.35]));
