...
export function createOpenUniverseAuthority(root=globalThis,{ctx,seedKey,maxGalaxies=8,maxRegions=10,maxSystems=12,cacheEntries=12}={}){
  ...
  let path=Object.freeze({universe,galaxy:null,region:null,neighborhood:null,system:null,body:null,surface:null,sample:null}),focus=universe,revision=0,world=null,currentWorldCacheKey=null,currentGalaxyWindowCacheKey=null,activeGalaxyWindow=seedGalaxyWindow,galaxyDiscovery=null,galaxies=[],windowsVisitedTotal=0,lastFailure=null;
  ...
  function loadGalaxyWindow(window){
    ...
    activeGalaxyWindow=context.window;currentGalaxyWindowCacheKey=cacheKey;galaxyDiscovery=context.discovery;galaxies=[...context.nodes];nodeIndex.clear();remember([universe,...galaxies]);rememberWindow(windowId);return context;
  }
  ...
  function visitGalaxyWindow(window){loadGalaxyWindow(window);path=Object.freeze({universe,galaxy:null,region:null,neighborhood:null,system:null,body:null,surface:null,sample:null});focus=universe;world=null;currentWorldCacheKey=null;lastFailure=null;revision++;pinPath();return snapshot()}
  ...
  function select(id){
    ...
    if(kind==='galaxy'){regionsFor(node);path=Object.freeze({...path,galaxy:node,region:null,neighborhood:null,system:null,body:null,surface:null,sample:null});world=null;currentWorldCacheKey=null}
