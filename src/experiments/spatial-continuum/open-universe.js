...
export function createOpenUniverseAuthority(root=globalThis,{ctx,seedKey,maxGalaxies=8,maxRegions=10,maxSystems=12,cacheEntries=12}={}){
  ...
  function selectSample(sampleId){
    ...
    world=materializeWorld({latMicroDeg:world.point.latMicroDeg,lonMicroDeg:world.point.lonMicroDeg,sampleId:object.entityId});path=Object.freeze({...path,sample:world.graph.get(world.sampleId)});focus=path.sample;revision++;pinPath();return world;
  }
