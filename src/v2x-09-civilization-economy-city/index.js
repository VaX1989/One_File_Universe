(function(root){
'use strict';
const O=root.OFU=root.OFU||{},K=O.v2x09CivilizationCore,I=O.v2x09CivilizationEconomyInit,E=O.v2x09CivilizationEconomyStep,S=O.v2x09CivilizationInstitutions,M=O.v2x09CivilizationMorphology,A=O.v2x09CivilizationAdvanced;
if(!K||!I||!E||!S||!M||!A)throw new Error('V2X-09 module set including advanced composition required');
