...
const LOCATION_OBSERVABLE='surface.location.identity',PLANET_OBSERVABLE='surface.planet.identity';
...
O.v2x06SurfaceCrossScale=Object.freeze({VERSION,AUTHORITY,LOCATION_OBSERVABLE,PLANET_OBSERVABLE,regime,makeRule,representation,refineContext,projectContext,reconcileContext});
})(globalThis);
