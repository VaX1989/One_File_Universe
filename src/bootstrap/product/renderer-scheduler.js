...
const state={version:'ofu-wave-iv-render-scheduler-1',suspendedPlanetFrames:0,executedPlanetFrames:0,livingPacerInstalled:false,livingRotationInputs:0,livingRotationFrames:0,livingRotationCoalesced:0,livingNavigationPacerInstalled:false,livingPinchInputs:0,livingPinchFrames:0,livingPinchCoalesced:0,livingPinchStaleDrops:0,livingPinchBoundaryCommits:0,livingWheelInputs:0,livingWheelFrames:0,livingWheelCoalesced:0,livingWheelStaleDrops:0};
...
function installLivingNavigationPacer(){
 ...
 const originalCreate=living.create.bind(living),version='ofu-living-navigation-pacer-1',wheelVersion='ofu-living-wheel-pacer-1',navigationStages=Array.from(living.NAVIGATION_STAGES||[]);
 function create(...args){
