(function(root){
'use strict';
const O=root.OFU=root.OFU||{},T=O.planetSurfaceTerrain;if(!T||typeof T.createTerrainSession!=='function')return;
const state={version:'ofu-wave-iv-surface-continuity-bind-2',bound:false,rebinds:0,lastPlanetId:null};
