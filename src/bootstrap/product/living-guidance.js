...
function ensureFirstFlightVisible(){
 ...
 clearMobileExposureRetry();state.mobileFirstFlightOffered=true;if(mobile.state.sheet==='expanded')return true;mobile.expand();state.mobileFirstFlightExpands++;return true
}
