...
const VERSION='ofu-v2x01-runtime-contracts-2';
...
O.v2x01Contracts=Object.freeze({VERSION,STATES,STATE_RANK,STATE_STARVATION_BOUND,TASK_CLASSES,EVIDENCE_STATES,HARD,DEFAULTS,CLASS_WEIGHTS,integer,state,taskClass,evidenceState,identity,durable,lineage,budgets,estimate,compareStates,logicalIdentityKey});
})(globalThis);
