...
function galaxyCell(seed,x,y,z){const a=[{kind:'text',value:'galaxy-cell'},{kind:'i64',value:BigInt(x)},{kind:'i64',value:BigInt(y)},{kind:'i64',value:BigInt(z)}];O.canonical.address(a);return {address:a,occupied:(q(seed,a,'galaxy','occupied')%7)===0,densityQ16:q(seed,a,'galaxy','density')&0xffff};}
